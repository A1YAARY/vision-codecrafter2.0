  ...
  const generateStockData = (market) => {
    const stockData = {
      Indian: [
        ...
        { name: "Infosys", price: 1485, change: "+8.2", percentChange: "0.56%" },
        { name: "TCS", price: 3520, change: "-15.7", percentChange: "-0.44%" },
        { name: "ICICI Bank", price: 880, change: "+5.6", percentChange: "0.64%" },
        { name: "Larsen & Toubro", price: 3250, change: "+20.9", percentChange: "0.65%" },
        { name: "Hindustan Unilever", price: 2250, change: "-12.3", percentChange: "-0.54%" },
        { name: "Kotak Mahindra Bank", price: 1750, change: "+7.8", percentChange: "0.45%" },
        { name: "Bharti Airtel", price: 850, change: "+9.2", percentChange: "1.1%" },
        { name: "State Bank of India", price: 610, change: "-4.7", percentChange: "-0.76%" },
        { name: "Bajaj Finance", price: 7800, change: "+34.5", percentChange: "0.44%" },
        { name: "ITC", price: 420, change: "-3.2", percentChange: "-0.76%" },
        { name: "Adani Enterprises", price: 2400, change: "+28.6", percentChange: "1.2%" },
        { name: "Asian Paints", price: 3120, change: "-10.5", percentChange: "-0.33%" },
        { name: "Titan Company", price: 2875, change: "+15.6", percentChange: "0.54%" },
        { name: "HCL Technologies", price: 1220, change: "+5.1", percentChange: "0.42%" },
        { name: "Wipro", price: 560, change: "-3.4", percentChange: "-0.6%" },
        { name: "UltraTech Cement", price: 8500, change: "+50.2", percentChange: "0.6%" },
        { name: "Sun Pharma", price: 1125, change: "+4.2", percentChange: "0.37%" },
        { name: "Maruti Suzuki", price: 10350, change: "-45.3", percentChange: "-0.43%" },
        { name: "Tata Steel", price: 123, change: "+1.5", percentChange: "1.2%" },
        { name: "Bajaj Auto", price: 4800, change: "-20.7", percentChange: "-0.43%" },
        { name: "Dr Reddy's Labs", price: 5250, change: "+30.8", percentChange: "0.59%" },
        { name: "Power Grid Corp", price: 260, change: "-1.9", percentChange: "-0.72%" },
        { name: "Nestle India", price: 22500, change: "+120.5", percentChange: "0.54%" },
        { name: "Oil & Natural Gas", price: 165, change: "-2.5", percentChange: "-1.49%" },
        { name: "Mahindra & Mahindra", price: 1900, change: "+15.3", percentChange: "0.8%" },
        { name: "Grasim Industries", price: 2000, change: "-9.6", percentChange: "-0.48%" },
        { name: "JSW Steel", price: 795, change: "+6.7", percentChange: "0.85%" },
      ],
      US: [
        ...
        { name: "Alphabet (Google)", price: 2800, change: "+25.6", percentChange: "0.9%" },
        { name: "NVIDIA", price: 220, change: "+4.5", percentChange: "2.1%" },
        { name: "Tesla", price: 225, change: "-5.2", percentChange: "-2.2%" },
        { name: "Meta Platforms (Facebook)", price: 330, change: "+6.7", percentChange: "2.1%" },
        { name: "Berkshire Hathaway", price: 430000, change: "+5000", percentChange: "1.2%" },
        { name: "Visa", price: 230, change: "+3.2", percentChange: "1.4%" },
        { name: "Johnson & Johnson", price: 165, change: "-2.1", percentChange: "-1.3%" },
        { name: "JPMorgan Chase", price: 150, change: "+2.8", percentChange: "1.9%" },
        { name: "Walmart", price: 145, change: "-1.0", percentChange: "-0.7%" },
        { name: "Procter & Gamble", price: 140, change: "+1.5", percentChange: "1.1%" },
        { name: "UnitedHealth Group", price: 500, change: "+10.0", percentChange: "2.0%" },
        { name: "Home Depot", price: 320, change: "-4.0", percentChange: "-1.2%" },
        { name: "Mastercard", price: 370, change: "+5.0", percentChange: "1.4%" },
        { name: "Bank of America", price: 40, change: "-0.5", percentChange: "-1.2%" },
        { name: "Pfizer", price: 45, change: "+0.8", percentChange: "1.8%" },
        { name: "Intel", price: 55, change: "-1.2", percentChange: "-2.1%" },
        { name: "Cisco Systems", price: 60, change: "+1.0", percentChange: "1.7%" },
        ...
        { name: "Coca-Cola", price: 60, change: "-0.3", percentChange: "-0.5%" },
        { name: "Walt Disney", price: 180, change: "+2.0", percentChange: "1.1%" },
        { name: "Oracle", price: 90, change: "+1.8", percentChange: "2.0%" },
        { name: "IBM", price: 140, change: "-1.0", percentChange: "-0.7%" },
        { name: "Exxon Mobil", price: 85, change: "+0.5", percentChange: "0.6%" },
      ...
      Japanese: [
        ...
        { name: "Mitsubishi UFJ Financial", price: 650, change: "+5.0", percentChange: "0.8%" },
        { name: "Keyence", price: 6000, change: "-50.0", percentChange: "-0.83%" },
        { name: "Nippon Telegraph & Telephone", price: 2800, change: "+20.0", percentChange: "0.72%" },
        { name: "Tokyo Electron", price: 5000, change: "-30.0", percentChange: "-0.6%" },
        { name: "Fast Retailing", price: 7000, change: "+50.0", percentChange: "0.72%" },
        { name: "Shin-Etsu Chemical", price: 4000, change: "+25.0", percentChange: "0.63%" },
        { name: "Hitachi", price: 4500, change: "-20.0", percentChange: "-0.44%" },
        { name: "Takeda Pharmaceutical", price: 3800, change: "+15.0", percentChange: "0.4%" },
        { name: "SoftBank Group", price: 5200, change: "-35.0", percentChange: "-0.67%" },
        { name: "KDDI", price: 3000, change: "+10.0", percentChange: "0.33%" },
        { name: "Mitsubishi Electric", price: 1600, change: "-5.0", percentChange: "-0.31%" },
        { name: "Sumitomo Mitsui Financial", price: 4100, change: "+20.0", percentChange: "0.49%" },
        { name: "Honda Motor", price: 3200, change: "-15.0", percentChange: "-0.47%" },
        { name: "Mizuho Financial Group", price: 1800, change: "+8.0", percentChange: "0.44%" },
        { name: "Daiichi Sankyo", price: 2800, change: "-12.0", percentChange: "-0.43%" },
        { name: "Sumitomo Corporation", price: 2200, change: "+10.0", percentChange: "0.45%" },
        { name: "Mitsui", price: 1800, change: "-5.0", percentChange: "-0.28%" },
        { name: "Mitsubishi", price: 1200, change: "+5.0", percentChange: "0.42%" },
        { name: "Panasonic", price: 1100, change: "-3.0", percentChange: "-0.27%" },
        { name: "Denso", price: 4500, change: "+20.0", percentChange: "0.45%" },
        { name: "Astellas Pharma", price: 2800, change: "-10.0", percentChange: "-0.36%" },
        { name: "Nissan Motor", price: 800, change: "+5.0", percentChange: "0.63%" },
        { name: "Suzuki Motor", price: 3000, change: "-15.0", percentChange: "-0.5%" },
        { name: "Fujitsu", price: 1200, change: "+5.0", percentChange: "0.42%" },
        { name: "Seven & i Holdings", price: 3500, change: "-10.0", percentChange: "-0.28%" },
        { name: "Kao", price: 2500, change: "+8.0", percentChange: "0.32%" },
        { name: "Nippon Steel", price: 1500, change: "-5.0", percentChange: "-0.33%" },
      ]
  };
